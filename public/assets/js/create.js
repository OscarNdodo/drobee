...
// ____________________________V2________________________
// Adicione esta função para criar o arquivo .md
// function createMarkdownFile(contentType) {
//     let markdownContent = '';
//     let filename = '';
...
// Modifique o event listener de submit para incluir o arquivo .md
// document.getElementById('uploadForm').addEventListener('submit', function (e) {
//     e.preventDefault();
...
//     // Para conteúdo de texto ou link, criar arquivo .md primeiro
//     if (contentType === 'text' || contentType === 'link') {
//         const { markdownContent, filename } = createMarkdownFile(contentType);

//         // Criar um Blob com o conteúdo Markdown
//         const blob = new Blob([markdownContent], { type: 'text/markdown' });

//         // Adicionar o arquivo ao FormData
//         formData.append('markdownFile', blob, filename);
//     }

//     if (activeTab === 'file-tab') {
//         // Simular progresso de upload (mantido do código original)
//         let progress = 0;
//         const interval = setInterval(() => {
//             progress += Math.random() * 10;
//             if (progress > 90) progress = 90;
...
//         }, 3000);
//     } else {
//         // Para conteúdo não-file, enviar imediatamente
//         fetch(form.action, {
//             method: 'POST',
//             body: formData
//         }).then(response => {
//             // Tratar resposta aqui
//             console.log('Envio completo', response);
//         });
//     }
// });


//_____________________________________V3_________________________________
// Tab 
...
// // Form submission with .md file creation
// document.getElementById('uploadForm').addEventListener('submit', function (e) {
//     e.preventDefault();
...
//     // For text or link content, create .md file first
//     if (contentType === 'text' || contentType === 'link') {
//         const { markdownContent, filename } = createMarkdownFile(contentType);
